...
from reCalcMaxOpportunityPlayer import reCalcMaxOpportunityPlayer

def main():
	VERBOSE = False;
	N_GAMES = 10000
	print("\nTic Tac Toe Platform\nRandom Player vs reCalculated Maximum Opportunity Player\n______________________\n")
	
	#player_maxO= reCalcMaxOpportunityPlayer(1,"reCalc Max Opportunity Player")
	#player_random = randomPlayer(2,"Random Player")
	
	player_random= reCalcMaxOpportunityPlayer(1,"reMax Opportunity Player")
